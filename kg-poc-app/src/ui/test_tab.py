...
TEST_SUITE = [
    ...
    {"id": 24, "cat": "databricks", "exp": "databricks",
    ...
    {"id": 31, "cat": "databricks", "exp": "databricks",
    ...
    {"id": 34, "cat": "databricks", "exp": "databricks",
    ...
    {"id": 37, "cat": "databricks", "exp": "databricks",
    ...
    {"id": 40, "cat": "databricks", "exp": "databricks",
    ...
    {"id": 60, "cat": "snowflake", "exp": "snowflake",
    ...
    {"id": 69, "cat": "snowflake", "exp": "snowflake",
    ...
    {"id": 78, "cat": "silver", "exp": "databricks",
     "q": "Describe the dim_product table structure"},
    {"id": 79, "cat": "silver", "exp": "databricks",
     "q": "What data is in the dim_store table?"},
    {"id": 80, "cat": "silver", "exp": "databricks",
     "q": "What fields does dim_employee contain?"},
    {"id": 81, "cat": "silver", "exp": "databricks",
